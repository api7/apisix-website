...
![软件架构](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/flow-software-architecture.png)

## 插件加载流程

![插件加载流程](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/flow-load-plugin.png)

## 插件内部结构

![插件内部结构](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/flow-plugin-internal.png)
