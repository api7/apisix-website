...
![plugin_skywalking](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/plugin/skywalking-1.png)
...
2. SkyWalking Web UI：
    ...
    2. 打开 Web UI 页面
        ...
        ![plugin_skywalking](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/plugin/skywalking-3.png)
...
3. 测试示例:
    ...
    - 打开浏览器，访问 SkyWalking 的 UI 页面：
        ...
        可以看到服务拓扑图\
        ![plugin_skywalking](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/plugin/skywalking-4.png)\
        可以看到服务追踪列表\
        ![plugin_skywalking](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/plugin/skywalking-5.png)
