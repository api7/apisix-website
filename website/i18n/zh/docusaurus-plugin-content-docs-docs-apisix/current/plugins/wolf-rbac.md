...
需要通过 [public-api](https://apisix.apache.org/docs/apisix/plugins/public-api) 插件来暴露它。
...
我们使用 [public-api](https://apisix.apache.org/docs/apisix/plugins/public-api) 插件来暴露这些 public API.
