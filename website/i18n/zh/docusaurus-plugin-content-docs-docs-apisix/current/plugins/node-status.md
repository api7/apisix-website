...
插件增加接口 `/apisix/status`，需要通过 [public-api](https://apisix.apache.org/docs/apisix/plugins/public-api) 插件来暴露它。
...
2. 为状态 API 配置路由，它将使用 [public-api](https://apisix.apache.org/docs/apisix/plugins/public-api) 插件。
