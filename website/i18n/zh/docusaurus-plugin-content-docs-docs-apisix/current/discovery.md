...
![discovery through service registry](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/discovery-cn.png)
...
基于 DNS 的服务注册发现见 [基于 DNS 的服务支持发现](https://apisix.apache.org/docs/apisix/discovery/dns)。

Consul 的支持见 [基于 Consul 的服务支持发现](https://apisix.apache.org/docs/apisix/discovery/consul_kv)

Nacos 的支持见 [基于 Nacos 的服务支持发现](https://apisix.apache.org/docs/apisix/discovery/nacos)
