...
![Apache APISIX 的技术架构](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/apisix.png)
...
- **微信公众号**
   <br/>![wechat official account](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/OA.jpg)
- **微信视频号**
   <br/>![wechat video account](https://raw.githubusercontent.com/apache/apisix/release/2.13/docs/assets/images/MA.jpeg)
...
- **运维友好**
  ...
  - 对接外部服务发现：除了内置的 etcd 外，还支持 [Consul](https://apisix.apache.org/discovery.md/docs/apisix/discovery)。
...
- **高度可扩展**
  ...
  - [插件可以用 Java/Go/Python 编写](https://apisix.apache.org/zh/docs/apisix/external-plugin)
